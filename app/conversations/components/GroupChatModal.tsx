      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="space-y-12">
          <div className="border-b border-gray-900/10 pb-12">
            <h2 className="text-base font-semibold leading-7 text-gray-900">Створити группу</h2>
            <p className="mt-1 text-sm leading-6 text-gray-600"> Створіть чат із більш ніж 2 людьми</p>
        ...
        <div className="mt-6 flex items-centter justify-end gap-x-6">
